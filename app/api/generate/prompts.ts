...
/** The selected appendix is intentionally byte-compatible with the old prompt
 * assembler. Keeping it last preserves the existing model behavior while the
 * full Skill becomes the reusable source of truth. */
